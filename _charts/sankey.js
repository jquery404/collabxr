    ...
    for(i=0;i<data.length;i++){
        ...
        for(j=0;j<cells.length;j++){
            if(i==0){
                ...
                else if(j==1 || j==2|| j==4 || j==5 || j==6 || j==10 || j==11 || j==12 || j==19 || j==20) table+= "<th>"+cells[j]+"</th>";
                ...
                else if(j==1 || j==2 || j==4 || j==5 || j==6 || j==10 || j==11 || j==12 || j==19 || j==20) {
                    if(j==11) cells[j] !='' ? table+= `<td><span class='collab_style' onmouseover="collabStyleOver(this)" onmouseout="collabStyleOut(this)"> ${cells[j]} </span></td>` : table+= "<td>" + cells[j] + "</td>";
